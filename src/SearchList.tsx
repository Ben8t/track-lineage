            ...
            tracks.map((track) => (
                <div className="m-2 max-w-sm rounded-lg border border-gray-200 bg-white p-6 shadow dark:border-gray-700 dark:bg-gray-800">
                    <form className="form grid grid-cols-2"
                        ...
                        <div>
                            <p className="font-mono font-normal text-purple dark:text-gray-400"
                                key={
                                    track.track.name
                            }>
                                <img src={
                        ...
                        <div>
                            <button className="hover:bg-purple-700 col-span-1 rounded bg-purple px-4 py-2 font-mono font-bold text-white" type="submit">
                                Add Track
                            </button>
                        </div>
                    </form>
